create database operaterassignment;
use hr;
...
-- 3Write a query to find employees with a salary less than 4000.
...
select * from  employees where COMMISSION_PCT  is not null and  MANAGER_ID is  null;

-- 5 Write a query to find employees in departments with IDs greater than 50.
select * from employees where department_id >50;
-- 6Write a query to display the employees with DEPARTMENT_ID equal to 90.
...
select * from employees where DEPARTMENT_ID =1700;
select * from employees;
...
select * from employees where salary = 6000;
 -- 20Write a query to display employees where SALARY is greater than 10000 or DEPARTMENT_ID is 60.
...
select * from jobs where min_salary <5000 or max_salary >20000;
...
SELECT * from employees where hire_date >= CURRENT_DATE - interval '10' YEAR;
...
SELECT * FROM employees e WHERE e.department_id = 50 OR e.salary > ( SELECT AVG(salary)FROM employees 
WHERE department_id = e.department_id);


-- 43 Write a query to find all countries where the REGION_ID is greater than 2 but not equal to 4.
select * from countries;
select * from countries where region_id >2 <>4;
...
select * from employees where salary > 5000 or not department_id =50;
...
select job_title from jobs where min_salary>5000 or max_salary <15000;
