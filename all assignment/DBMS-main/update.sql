...
update employees set email = "not avilable"  where employee_id between 102 and 206;
desc employees;
...
update employees set email = "not avilable"  where employee_id between 102 and 206;
update employees set commission_pct = 0.10 where employee_id between 102 and 206;
...
update employees set email = "not avilable"  where department_id =110;
update employees set commission_pct = 0.10 where department_id =110;
...
update employees set email = 'not avilable' where department_id =80;
update employees set commission_pct=0.20 where department_id =80 and commission_pct <0.20;
...
update employees set email = 'not avilable' where departments = accounting;
